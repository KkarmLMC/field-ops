...
export const JOBS = [
  // ── ACTIVE ──
  { id: 'JOB-2026-0312', branch: 'bolt', type: 'installation', status: 'active',       customer: 'Ritz-Carlton',                  siteName:'Ritz-Carlton Amelia Island',          address: '4750 Amelia Island Pkwy, Fernandina Beach, FL 32034', structure: 'Hotel / Resort — 12-story, 280ft',                      assignedTo: 'T003', scheduledDate: '2026-03-24', nfpaClass: 'I',   priority: 'high',   progress: 65,  forms: ['site-survey', 'installation'], notes: 'Rooftop HVAC bonding required. Elevator shaft grounding per UL 96A §4.2.' },
  { id: 'JOB-2026-0318', branch: 'bolt', type: 'installation', status: 'active',       customer: 'Nassau County Government',      siteName:'Nassau County Courthouse',            address: '76 S 4th St, Fernandina Beach, FL 32034',            structure: 'Government — 3-story, 52ft, historic masonry',          assignedTo: 'T006', scheduledDate: '2026-03-24', nfpaClass: 'I',   priority: 'high',   progress: 40,  forms: ['site-survey'],                notes: 'Historic preservation constraints. No drilling into original facade.' },
  { id: 'JOB-2026-0321', branch: 'bolt', type: 'inspection',   status: 'ul-inspection',customer: 'Omni Hotels & Resorts',         siteName:'Omni Amelia Island Resort',           address: '39 Beach Lagoon Rd, Amelia Island, FL 32034',         structure: 'Resort — 8-story tower + 4 villa clusters, 220ft',      assignedTo: 'T004', scheduledDate: '2026-03-24', nfpaClass: 'I',   priority: 'medium', progress: 75,  forms: ['site-survey', 'inspection'],  notes: 'Annual inspection per contract. Pool area bonding check added this year. Awaiting UL sign-off.' },
  { id: 'JOB-2026-0315', branch: 'lm',   type: 'installation', status: 'active',       customer: 'Rayonier Advanced Materials',   siteName:'Rayonier Chemical Plant — Unit 3',    address: '1301 Rayonier Way, Fernandina Beach, FL 32034',       structure: 'Chemical — Processing unit, 95ft, classified area',     assignedTo: 'T001', scheduledDate: '2026-03-24', nfpaClass: 'II',  priority: 'high',   progress: 55,  forms: ['site-survey', 'installation'], notes: 'Class I Div 2 hazardous area. Intrinsically safe bonding required.' },
  { id: 'JOB-2026-0317', branch: 'lm',   type: 'inspection',   status: 'ul-inspection',customer: 'Port of Fernandina',            siteName:'Port Crane Complex — Bay 4',          address: '1 Front St, Fernandina Beach, FL 32034',             structure: 'Industrial — Port crane, 180ft, saltwater environment', assignedTo: 'T005', scheduledDate: '2026-03-24', nfpaClass: 'II',  priority: 'high',   progress: 90,  forms: ['site-survey', 'inspection'],  notes: 'Saltwater corrosion expected on ground rods. Full test required. UL final review pending.' },

  // ── AWAITING PO ──
  { id: 'JOB-2026-0345', branch: 'lm',         type: 'installation', status: 'awaiting-po', customer: 'ExxonMobil',               siteName:'ExxonMobil Refinery — Unit 7',        address: '1600 Refinery Blvd, Fernandina Beach, FL 32034',     structure: 'Industrial — Refinery unit, 120ft, classified area',  assignedTo: 'T001', scheduledDate: '2026-04-07', nfpaClass: 'II',  priority: 'high',   progress: 0, forms: [], notes: 'Awaiting procurement approval. PO routed to facility manager.' },
  { id: 'JOB-2026-0347', branch: 'bolt',        type: 'site-survey',  status: 'awaiting-po', customer: 'Marriott International',   siteName:'Marriott Sawgrass Resort',            address: '1000 PGA Tour Blvd, Ponte Vedra Beach, FL 32082',    structure: 'Resort — 7-story, 220 rooms, pool complex',           assignedTo: 'T002', scheduledDate: '2026-04-10', nfpaClass: 'I',   priority: 'medium', progress: 0, forms: [], notes: 'New client. Finance team reviewing quote. PO expected by April 1.' },
  { id: 'JOB-2026-0349', branch: 'bolt-dallas', type: 'installation', status: 'awaiting-po', customer: 'Tesla',                    siteName:'Tesla Gigafactory Texas',             address: '13101 Harold Green Rd, Austin, TX 78725',            structure: 'Industrial — Gigafactory, multiple structures, 80ft', assignedTo: 'T007', scheduledDate: '2026-04-14', nfpaClass: 'II',  priority: 'high',   progress: 0, forms: [], notes: 'Large scope — 22 structures. Legal review ongoing. PO pending.' },

  // ── SCHEDULED ──
  { id: 'JOB-2026-0298', branch: 'lm',   type: 'inspection',   status: 'scheduled',    customer: 'Port of Fernandina',            siteName:'Port of Fernandina — Crane Complex',  address: '1 Front St, Fernandina Beach, FL 32034',             structure: 'Industrial — Port crane cluster, tallest 180ft',        assignedTo: 'T001', scheduledDate: '2026-03-25', nfpaClass: 'II',  priority: 'high',   progress: 0,   forms: [],                             notes: 'Annual inspection. Last certified 2025-03-10. Saltwater corrosion expected.' },
  { id: 'JOB-2026-0287', branch: 'bolt', type: 'site-survey',  status: 'scheduled',    customer: 'Baptist Health',                siteName:'Baptist Medical Center Nassau',       address: '1250 S 18th St, Fernandina Beach, FL 32034',         structure: 'Healthcare — 4-story, 68ft, critical facility',         assignedTo: 'T002', scheduledDate: '2026-03-26', nfpaClass: 'I',   priority: 'medium', progress: 0,   forms: [],                             notes: 'Pre-install survey for generator pad bonding and rooftop expansion.' },
  { id: 'JOB-2026-0325', branch: 'bolt', type: 'site-survey',  status: 'scheduled',    customer: 'Fernandina Beach Golf Club',    siteName:'Fernandina Beach Golf Club',          address: '2800 Bill Melton Rd, Fernandina Beach, FL 32034',    structure: 'Commercial — Clubhouse + maintenance barn, 35ft',       assignedTo: 'T005', scheduledDate: '2026-03-27', nfpaClass: 'III', priority: 'low',    progress: 0,   forms: [],                             notes: 'New client inquiry. Insurance requiring LPS evaluation post-strike.' },
  { id: 'JOB-2026-0330', branch: 'bolt', type: 'installation', status: 'scheduled',    customer: 'University of North Florida',   siteName:'Kraft Athletic Club at UNF',          address: '1 UNF Drive, Jacksonville, FL 32224',                structure: 'Educational — Athletic facility, steel frame, 65ft',    assignedTo: 'T003', scheduledDate: '2026-03-28', nfpaClass: 'II',  priority: 'medium', progress: 0,   forms: ['site-survey'],                notes: 'Installing 24 air terminals, 8 down conductors. Coordinate for outage window.' },
  { id: 'JOB-2026-0334', branch: 'lm',   type: 'annual-test',  status: 'scheduled',    customer: 'WestRock Company',              siteName:'WestRock Paper Mill',                 address: '1500 N 8th St, Fernandina Beach, FL 32034',          structure: 'Industrial — Paper mill, multiple stacks, 140ft',       assignedTo: 'T001', scheduledDate: '2026-03-29', nfpaClass: 'II',  priority: 'high',   progress: 0,   forms: [],                             notes: 'Hazardous — paper dust ignition risk. Full PPE + escort required.' },
  { id: 'JOB-2026-0338', branch: 'lm',   type: 'annual-test',  status: 'scheduled',    customer: 'Publix',                        siteName:'Fernandina Warehouse Complex',         address: '4500 Buccaneer Trail, Yulee, FL 32097',              structure: 'Industrial — Warehouse, 42ft, steel frame',            assignedTo: 'T005', scheduledDate: '2026-03-30', nfpaClass: 'III', priority: 'low',    progress: 0,   forms: [],                             notes: 'Routine biannual. Check NE corner bracket corrosion noted last visit.' },

  // ── COMPLETED ──
  { id: 'JOB-2026-0271', branch: 'lm',   type: 'certification',status: 'completed',    customer: 'Rayonier Advanced Materials',   siteName:'Rayonier Advanced Materials — Plant', address: '1301 Rayonier Way, Fernandina Beach, FL 32034',       structure: 'Industrial — Processing plant, multiple structures',    assignedTo: 'T004', scheduledDate: '2026-03-20', nfpaClass: 'II',  priority: 'medium', progress: 100, forms: ['site-survey', 'installation', 'inspection'], notes: 'Certified. All 7 structures passed. Certificate #BOLT-2026-0271 issued.' },
  { id: 'JOB-2026-0255', branch: 'bolt', type: 'installation', status: 'completed',    customer: 'Florida State Parks',           siteName:'Amelia Island Lighthouse',            address: "215 O'Hagan Ln, Fernandina Beach, FL 32034",         structure: 'Historic — Lighthouse tower, 64ft, brick/masonry',     assignedTo: 'T002', scheduledDate: '2026-03-14', nfpaClass: 'I',   priority: 'high',   progress: 100, forms: ['site-survey', 'installation', 'inspection'], notes: 'Historic site — State Parks approval obtained. All readings <5Ω.' },
  { id: 'JOB-2026-0248', branch: 'bolt', type: 'annual-test',  status: 'completed',    customer: 'City of Fernandina Beach',      siteName:'Fernandina Beach Municipal Airport',  address: '1600 Airport Rd, Fernandina Beach, FL 32034',        structure: 'Aviation — Control tower 48ft, hangar complex',        assignedTo: 'T005', scheduledDate: '2026-03-12', nfpaClass: 'I',   priority: 'high',   progress: 100, forms: ['site-survey', 'inspection'],  notes: 'Annual test passed. All 4 ground electrode stations ≤6Ω. FAA compliance letter sent.' },
  { id: 'JOB-2026-0240', branch: 'lm',   type: 'inspection',   status: 'completed',    customer: 'Publix',                        siteName:'Publix Distribution Center',          address: '4500 Buccaneer Trail, Yulee, FL 32097',              structure: 'Industrial — Warehouse complex, 42ft, steel frame',    assignedTo: 'T006', scheduledDate: '2026-03-10', nfpaClass: 'III', priority: 'low',    progress: 100, forms: ['site-survey', 'inspection'],  notes: 'Minor corrosion on NE corner down conductor bracket — noted for next service.' },
  { id: 'JOB-2026-0232', branch: 'bolt', type: 'certification',status: 'completed',    customer: 'Osprey Village',                siteName:'Osprey Village Retirement Community', address: '600 Osprey Village Dr, Amelia Island, FL 32034',     structure: 'Residential — 6 buildings, tallest 3-story, 38ft',     assignedTo: 'T003', scheduledDate: '2026-03-08', nfpaClass: 'III', priority: 'medium', progress: 100, forms: ['site-survey', 'installation', 'inspection'], notes: 'Full LPS across all 6 buildings. Certificate #BOLT-2026-0232 issued.' },
  { id: 'JOB-2026-0220', branch: 'bolt', type: 'installation', status: 'completed',    customer: 'First Baptist Church',          siteName:'First Baptist Church — Fernandina',  address: '1600 S 8th St, Fernandina Beach, FL 32034',          structure: 'Religious — Sanctuary + steeple, 85ft',                assignedTo: 'T001', scheduledDate: '2026-03-05', nfpaClass: 'I',   priority: 'medium', progress: 100, forms: ['site-survey', 'installation', 'inspection'], notes: 'Steeple custom air terminal mount. Ground resistance 3.2Ω at all stations.' },

  // ── BOLT DALLAS ──
  { id: 'JOB-2026-0401', branch: 'bolt-dallas', type: 'installation', status: 'active',       customer: 'Oncor Electric Delivery',   siteName:'Oncor Transmission Substation',       address: '1616 Woodall Rodgers Fwy, Dallas, TX 75202',         structure: 'Utility — Transmission substation, 85ft steel lattice', assignedTo: 'T007', scheduledDate: '2026-03-24', nfpaClass: 'II',  priority: 'high',   progress: 50,  forms: ['site-survey', 'installation'], notes: 'High-voltage substation. Full PPE and utility coordination required.' },
  { id: 'JOB-2026-0408', branch: 'bolt-dallas', type: 'inspection',   status: 'ul-inspection',customer: 'AT&T',                      siteName:'AT&T Discovery District Tower',        address: '208 S Akard St, Dallas, TX 75202',                   structure: 'Commercial — 29-story tower, 430ft',                    assignedTo: 'T008', scheduledDate: '2026-03-27', nfpaClass: 'I',   priority: 'medium', progress: 85,  forms: ['site-survey', 'inspection'],  notes: 'Annual high-rise inspection. Elevator machine room bonding required. UL sign-off pending.' },
  { id: 'JOB-2026-0415', branch: 'bolt-dallas', type: 'certification',status: 'completed',    customer: 'Dallas Cowboys',            siteName:'Dallas Cowboys Training Facility',    address: '9 Cowboys Way, Frisco, TX 75034',                    structure: 'Sports — Training complex, 3 buildings, max 60ft',      assignedTo: 'T007', scheduledDate: '2026-03-15', nfpaClass: 'I',   priority: 'medium', progress: 100, forms: ['site-survey', 'installation', 'inspection'], notes: 'Full LPS across 3 buildings. All readings <4Ω. Certificate issued.' },
  { id: 'JOB-2026-0422', branch: 'bolt-dallas', type: 'annual-test',  status: 'scheduled',    customer: 'Pioneer Natural Resources', siteName:'Pioneer Natural Resources HQ',        address: '777 Hidden Ridge, Irving, TX 75038',                 structure: 'Energy — Corporate campus, 8-story, 130ft',             assignedTo: 'T008', scheduledDate: '2026-03-30', nfpaClass: 'II',  priority: 'high',   progress: 0,   forms: ['site-survey'],                notes: 'Annual test for energy sector compliance. Wind turbine bonding included.' },

  // ── POSTPONED ──
  { id: 'JOB-2026-0351', branch: 'lm',         type: 'installation', status: 'postponed',    customer: 'Georgia-Pacific',           siteName:'Georgia-Pacific Mill — Stack 2',      address: '1 Mill Rd, Palatka, FL 32177',                       structure: 'Industrial — Paper mill stack, 160ft',                assignedTo: 'T005', scheduledDate: '2026-04-01', nfpaClass: 'II',  priority: 'high',   progress: 0, forms: [], notes: 'Postponed — client facility outage rescheduled. New date TBD.' },
  { id: 'JOB-2026-0353', branch: 'bolt',        type: 'annual-test',  status: 'postponed',    customer: 'Sea Turtle Inn',            siteName:'Sea Turtle Inn',                      address: '1 Ocean Blvd, Atlantic Beach, FL 32233',             structure: 'Hospitality — Beachfront hotel, 6-story, 72ft',       assignedTo: 'T003', scheduledDate: '2026-03-22', nfpaClass: 'I',   priority: 'low',    progress: 0, forms: [], notes: 'Postponed at client request — peak spring season. Rescheduled to June.' },
  { id: 'JOB-2026-0355', branch: 'bolt-dallas', type: 'site-survey',  status: 'postponed',    customer: 'Hunt Oil Company',          siteName:'Hunt Oil HQ',                         address: '1900 N Akard St, Dallas, TX 75201',                  structure: 'Commercial — 14-story corporate tower, 210ft',        assignedTo: 'T008', scheduledDate: '2026-03-20', nfpaClass: 'I',   priority: 'medium', progress: 0, forms: [], notes: 'Postponed — building access permit delayed by city. Rescheduling in progress.' },

  // ── FAILED ──
  { id: 'JOB-2026-0263', branch: 'bolt', type: 'annual-test',  status: 'failed',       customer: 'Amelia Island Plantation',      siteName:'Amelia Island Plantation',            address: '39 Beach Lagoon Rd, Amelia Island, FL 32034',        structure: 'Resort — Multiple buildings, tallest 45ft',            assignedTo: 'T001', scheduledDate: '2026-03-18', nfpaClass: 'I',   priority: 'high',   progress: 90,  forms: ['site-survey', 'inspection'],  notes: 'FAILED: Ground resistance 28Ω at Buildings C. Exceeds 10Ω limit. Remediation order issued.' },
  { id: 'JOB-2026-0244', branch: 'lm',   type: 'inspection',   status: 'failed',       customer: 'Sadler Point Marina',           siteName:'Sadler Point Marina',                 address: '4669 Roosevelt Blvd, Jacksonville, FL 32210',        structure: 'Marine — Fuel dock + ship store, 28ft, wood frame',    assignedTo: 'T004', scheduledDate: '2026-03-11', nfpaClass: 'I',   priority: 'high',   progress: 85,  forms: ['site-survey', 'inspection'],  notes: 'FAILED: 3 of 6 air terminals missing — storm damage. Fuel dock bonding compromised. Urgent.' },
  { id: 'JOB-2026-0236', branch: 'lm',   type: 'annual-test',  status: 'failed',       customer: 'St. Augustine Distillery',      siteName:'St. Augustine Distillery',            address: '112 Riberia St, St. Augustine, FL 32084',            structure: 'Historic/Industrial — Distillery, 46ft, brick',        assignedTo: 'T006', scheduledDate: '2026-03-09', nfpaClass: 'I',   priority: 'high',   progress: 80,  forms: ['inspection'],                 notes: 'FAILED: Ground resistance 15Ω — soil dried out. Flammable vapor — critical. Add supplemental ground rods.' },
];
