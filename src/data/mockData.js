...
export const JOBS = [
  ...
  { id: 'JOB-2026-0321', branch: 'bolt', type: 'inspection',   status: 'active',    client: 'Omni Amelia Island Resort',      address: '39 Beach Lagoon Rd, Amelia Island, FL 32034',         structure: 'Resort — 8-story tower + 4 villa clusters, 220ft',      assignedTo: 'T004', scheduledDate: '2026-03-24', nfpaClass: 'I',   priority: 'medium', progress: 30,  forms: ['site-survey'],                notes: 'Annual inspection per contract. Pool area bonding check added this year.' },
  ...
  { id: 'JOB-2026-0317', branch: 'lm',   type: 'inspection',   status: 'active',    client: 'Port Crane Complex — Bay 4',     address: '1 Front St, Fernandina Beach, FL 32034',             structure: 'Industrial — Port crane, 180ft, saltwater environment', assignedTo: 'T005', scheduledDate: '2026-03-24', nfpaClass: 'II',  priority: 'high',   progress: 20,  forms: [],                             notes: 'Saltwater corrosion expected on ground rods. Full test required.' },
