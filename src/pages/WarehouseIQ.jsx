    ...
    <div className="page-content fade-in">
      ...
      <div className="warehouse-i-q-4f2e">
        ...
        <div className="flex-gap-s">
          <div style={{ padding: 'var(--space-s) var(--space-l)', borderRadius:'var(--radius-l)', background: isClosed ? 'var(--grey-tint-80)' : 'var(--brand-primary)', color: isClosed ? 'var(--grey-base)' : '#fff', fontWeight: 'var(--fw-bold)', fontSize:'var(--text-sm)' }}>
            {periodLabel}
          </div>
          {isClosed
            ? <span className="warehouse-i-q-8323">Closed</span>
      ...
      {pos.length > 0 && (
        <div className="warehouse-i-q-7cb6">
          <div className="warehouse-i-q-43a7">
            <div className="flex-gap-s">
          ...
          {pos.map((po, idx) => (
            <button key={idx} onClick={() => navigate(`/sales-orders/${po.id || ''}`)}
              ...
              <span style={{ fontSize:'var(--text-xs)', fontWeight: 'var(--fw-bold)', padding:'2px 8px', borderRadius:'var(--radius-s)', background: po.status==='queued'?'var(--purple-soft)':po.status==='running'?'var(--warning-soft)':po.status==='fulfillment'?'var(--state-info-soft)':po.status==='shipment'?'var(--blue-tint-80)':'var(--state-success-soft)', color: po.status==='queued'?'var(--purple-tint-20)':po.status==='running'?'var(--warning)':po.status==='fulfillment'?'var(--state-info)':po.status==='shipment'?'var(--blue-shade-20)':'var(--state-success-text)', textTransform:'capitalize', flexShrink:0 }}>
                {po.status}
              </span>
            </button>
          ))}
      ...
      <div className="warehouse-i-q-63aa">
        ...
        {/* Table toolbar */}
        <div className="warehouse-i-q-9ea5">
          {/* Search */}
          ...
          return (
            ...
            >
              ...
              <div style={{ minWidth:0 }}>
                ...
                {r.part.sku && <div className="warehouse-i-q-8c39">{r.part.sku}</div>}
              </div>
              {/* Start */}
        ...
        {/* Totals footer */}
        {filtered.length > 0 && (
          <div className="warehouse-i-q-2da3">
            ...
            <div className="warehouse-i-q-6f12">
            ...
            <div className="warehouse-i-q-fedb">
