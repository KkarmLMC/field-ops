...
export default function Profile() {
  ...
  const saveName = async () => {
    ...
    flash('Name updated.')
    logActivity(db, user?.id, 'field_ops', { category: 'profile', action: 'updated_name', label: 'Updated display name' })
  }
  ...
  const savePassword = async () => {
    ...
    logActivity(db, user?.id, 'field_ops', { category: 'profile', action: 'updated_password', label: newEmail ? 'Updated email and password' : 'Changed password' })
  ...
  const handlePinStep = async (pin) => {
    ...
    if (pinSection === 'verify-old') {
      ...
      logActivity(db, user?.id, 'field_ops', { category: 'profile', action: 'updated_pin', label: 'Changed login PIN' })
    }
  }
