          ...
          {parts.map((part, idx) => (
            <button key={part.id} onClick={() => onPartPress(part.id)}
              style={{
                ...
                borderBottom: idx < parts.length - 1 ? '1px solid var(--border-default)' : 'none',
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ display: 'flex', gap: 'var(--space-m)', marginTop: 2, flexWrap: 'wrap' }}>
                  {part.sku && <span style={{ fontSize: 'var(--text-xs)', fontFamily: 'var(--font-mono)', color: 'var(--text-muted)' }}>{part.sku}</span>}
