    ...
    <div className="page-content fade-in">
      ...
      <div style={{ background: 'var(--surface-base)', borderRadius: 'var(--radius-m)', padding: 'var(--space-xl)', marginBottom: 'var(--space-l)' }}>
        ...
        <Field label="SKU / Part Number">
          <input value={form.sku} onChange={e => set('sku', e.target.value)} placeholder="e.g. AT-FR-12-CU" style={{ width: '100%', fontFamily: 'var(--font-mono)' }} />
        </Field>
        ...
        <Field label="Manufacturer Part No.">
          <input value={form.manufacturer_part_no} onChange={e => set('manufacturer_part_no', e.target.value)} placeholder="e.g. LMC-1234-A" style={{ width: '100%', fontFamily: 'var(--font-mono)' }} />
        </Field>
        ...
        <Field label="Barcode (manufacturer)">
          <input value={form.barcode} onChange={e => set('barcode', e.target.value)} placeholder="Scan or enter barcode" style={{ width: '100%', fontFamily: 'var(--font-mono)' }} />
        </Field>
