    ...
    <div className="page-content fade-in">
      ...
      <div className="card-section">
        ...
        <Field label="SKU / Part Number">
          <input value={form.sku} onChange={e => set('sku', e.target.value)} placeholder="e.g. AT-FR-12-CU" className="add-edit-part-cce7" />
        </Field>
        ...
        <Field label="Manufacturer Part No.">
          <input value={form.manufacturer_part_no} onChange={e => set('manufacturer_part_no', e.target.value)} placeholder="e.g. LMC-1234-A" className="add-edit-part-cce7" />
        </Field>
        ...
        <Field label="Barcode (manufacturer)">
          <input value={form.barcode} onChange={e => set('barcode', e.target.value)} placeholder="Scan or enter barcode" className="add-edit-part-cce7" />
        </Field>
